        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select id="ComboAction" class="form-control" style="height: 33px;" onchange="ChangeRelease('1')">
                                        ...
                                        <option value="Change">Change Skill Outbound (Release Data Outbound)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" id="DisplayTanggal">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Tanggal Data Outbound&nbsp;<span class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-bars"></i></span>
                                    </div>
                    ...
                    <div class="row" id="DisplayCall">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Status Data Outbound&nbsp;<span class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-bars"></i></span>
                                    </div>
                                    <select id="ComboStatusData" class="form-control" style="height: 33px;">
                                        <option value="">Select</option>
                                        <option value="0">Belum Call</option>
                                        <option value="1">Sudah Call</option>
                                    </select>
                                </div>
                            </div>
                        </div>
