            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Notification Template&nbsp;<i class="fa fa-plus" onclick="showAdd()" style="cursor:pointer;"></i></h4>
                    </div>
                    <div class="box-body">
                        <table id="TrmNotificationTemplate" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 400px;">Body Template</th>
            ...
            <div class="modal-content" style="width: 1200px; margin-left: -350px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                 <label>Template (Maksimal 7500 Character) <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="select" id="ComboAccount" class="form-control" style="height:33px;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="select" id="cmbCategory" class="form-control" onchange="cmbTypeOnchange(1);" style="height:33px;">
                                    <option value="">Select</option>
