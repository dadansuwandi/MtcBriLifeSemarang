                                ...
                                <div class="media align-items-top p-0">
                                    <div class="d-lg-flex d-block justify-content-between align-items-center w-p100">
                                        <div>
                                            ...
                                            <a href="#" onclick="AgentProductCampaign();"><span class="badge badge-pill badge-default" style="font-weight: bold; font-size: 14px;">+ Add Agent Product Campaign</span></a>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Select Product Campaign</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Select Maximal Campaign Data</label>
