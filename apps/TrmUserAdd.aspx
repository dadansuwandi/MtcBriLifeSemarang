                                ...
                                <div class="box-body" style="display: block;">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkboxEmail" onclick="EmailCheck(this.checked)" disabled="disabled">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkboxWA" onclick="WACheck(this.checked)" disabled="disabled">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkboxInstagram" onclick="InstagramCheck(this.checked)" disabled="disabled">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkboxFacebook" onclick="FacebookCheck(this.checked)" disabled="disabled">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkboxTwitter" onclick="TwitterCheck(this.checked)" disabled="disabled">
