            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Category Type&nbsp;<i class="fa fa-plus" onclick="showAdd()"></i></h4>
                        <center>
                        ...
                        <table id="TrmCategoryType" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 400px;">Category Type</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Category Type</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="TxtCategoryTypeName" placeholder="Category Type Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
