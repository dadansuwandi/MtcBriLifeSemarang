...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="TrxPhoneNumber" runat="server" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-lg" type="text" placeholder="Nomor Kartu" id="Journey_PolisNumber" name="Journey_PolisNumber" title="Nomor Kartu">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-lg" type="text" placeholder="Badan Usaha" id="Journey_BadanUsaha" name="Journey_PolisNumber" title="Badan Usaha">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="position-relative p-20">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                     ...
                                                     <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="text-primary">Reason Call</label>
                                                            <p class="font-weight-normal" id="Ticket_ReasonCall"></p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="text-primary">Claim Number</label>
                                                ...
                                                <div class="row">                                                   
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-primary">Provider Name</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="text-primary">Escalation Type</label>
                                                            <p class="font-weight-normal" id="Ticket_EscalationType"></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="select" id="Journey_Callback" required class="form-control" style="height: 33px;" onchange="CallbackChange('1')">
                                                    <option value="">Select</option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Reason Call</label><span class="badge badge-pill badge-warning float-right" id="dialcall"><a href="#" style="color: white;" title="Outbound Call"><i class="fa fa-phone" onclick="ClickCall()"></i></a></span><span id="dropcall"></span>
                                                <select name="select" id="Journey_ReasonCall" required class="form-control" style="height: 33px;">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
