            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data User Export</h4>
                    </div>
                    <div class="box-body">                      
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Styles-Header-HorizontalAlign="Center"
                            Theme="MetropolisBlue" DataSourceID="XtraUser" Styles-Header-Font-Bold="true" Font-Size="X-Small" Styles-Cell-HorizontalAlign="Center">
                            <SettingsPager>
                                <AllButton Text="All">
                                </AllButton>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Email Address" FieldName="EMAIL_ADDRESS" Width="205px"></dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Group Agent" FieldName="NamaGrup" Width="205px"></dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Status" FieldName="StatusNya" Width="205px"></dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
                        <hr />
                        <div class="row">
