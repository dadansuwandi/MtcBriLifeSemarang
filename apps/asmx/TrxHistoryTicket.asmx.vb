...
Public Class TrxHistoryTicket1
    ...
    Public Function UIDESK_TrxHistoryTicket(ByVal TrxStartDate As String, ByVal TrxEnddate As String, ByVal TrxUserName As String, ByVal TrxTicketNumber As String,
                                            ByVal TrxFilterType As String) As String
