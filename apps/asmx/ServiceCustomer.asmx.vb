...
Public Class ServiceCustomer
    ...
    Public Function InsertTransactionCustomer(ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String, ByVal TrxCusTomerPhone As String,
                                              ...
                                              ByVal TrxNumberID As String, ByVal TrxCIF As String, ByVal TrxBadanUsaha As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxBadanUsaha", TrxBadanUsaha)
                con.Open()
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_Temp_InsertCustomer '" & TrxCustomerID & "','" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxCusTomerGender & "','" & TrxCusTomerDate & "','" & TrxCustomerPolisNumber & "','" & TrxCusTomerNIK & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxUsernameXSS & "','" & TrxCustomerID & "','" & TrxGenerateID & "','" & TrxCIF & "', '" & TrxBadanUsaha & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionCustomer(ByVal TrxCustomerID As String, ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String,
                                              ByVal TrxCusTomerPhone As String, ByVal TrxCusTomerGender As String, ByVal TrxCusTomerDate As String, ByVal TrxCusTomerAlamat As String,
                                              ByVal TrxCIF As String, ByVal TrxBadanUsaha As String, ByVal TrxCusTomerNIK As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Result As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_Temp_UpdateCustomer '" & TrxCustomerID & "','" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxCusTomerGender & "','" & TrxCusTomerDate & "','" & TrxCustomerID & "','" & TrxCusTomerNIK & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxUsernameXSS & "','" & TrxCIF & "','" & TrxBadanUsaha & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
