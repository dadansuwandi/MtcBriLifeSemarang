                        ...
                        <hr />
                         <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="ID" Theme="MetropolisBlue"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Reason Call" FieldName="ResponseComplaintNonHtml" Width="300px" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Phone Number" FieldName="ResponseComplaintNonHtml" Width="300px" VisibleIndex="4"></dx:GridViewDataTextColumn>
