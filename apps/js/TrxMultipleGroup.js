...
function TrmAgentSetting() {
    $.ajax({
        type: "POST",
        url: "asmx/TrxMultipleGroup.asmx/MultipleGroupTransaksi",
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                resultUserNotification = '<div class="col-md-12 col-lg-2">' +
                    ...
                    '<span class="badge badge-pill badge-primary badge-lg"><small>Group Agent ' + json[i].NamaGrup + '</small></span>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>'
                        ...
                        for (i = 0; i < json.length; i++) {
                            if (json[i].Result == "True") {
                                swal(
                                    ...
                                    window.location.href = "TrxMultipleGroup.aspx"
                                });
                            } else {
                                swal(
                                    '',
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                result = '<option value="' + json[i].IdGrup + '">' + json[i].NamaGrup + '</option>';
