            ...
            if (json.length == 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    var urlClick = "<div class='dropdown'>" +
                        ...
                        "<a class='dropdown-item' href='http://10.28.2.222/brilifecc/FileEmail/INBOX/" + json[i].EMAIL_ID + "/file.html' target='_blank'><i class='mdi mdi-book-open'></i> File Email</a>" +
            ...
            if (json.length == 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    var urlClick = "<div class='dropdown'>" +
                        ...
                        "<div class='dropdown-menu dropdown-menu-right'>" +
                        "<a class='dropdown-item' href='http://10.28.2.222/brilifecc/FileEmail/OUTBOX/" + json[i].EMAIL_ID + "/file.html' target='_blank'><i class='mdi mdi-book-open'></i> File Email</a>" +
                        "<a class='dropdown-item' href='#' onclick=PreviewAttachmnent('" + json[i].EMAIL_ID + "')><i class='mdi mdi-paperclip'></i> Attachment</a>" +
                        "</div>" +
                        "</div>"
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                if (json[i].DIRECTION == "IN") {
                    var FileAttachment = "http://10.28.2.222/brilifecc/FileEmail/INBOX/"
                } else if (json[i].DIRECTION == "OUT") {
                    var FileAttachment = "http://10.28.2.222/brilifecc/FileEmail/OUTBOX/"
                }
