            ...
            if (json.length > 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    ...
                    if (json[i].Sync_Status == "Completed") {
                        var IconTicket = "<i class='fa fa-check-circle text-success'></i>"
                    } else {
                        var IconTicket = "<i class='fa fa-circle text-success'></i>"
                    }
                    if (json[i].Sync_Status_Thread == "Completed") {
                        var IconThread = "<i class='fa fa-check-circle text-danger'></i>"
                    } else {
                        var IconThread = "<i class='fa fa-circle text-danger'></i>"
                    }
