...
$(document).on("change", "input[name='files']", function (e) {
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        request.done(function (response) {
            ...
            //moveFileToDatabase('FileNasabah/4fb1a239-8b70-426b-8390-8f8ca997dc4719.xlsx','FileNasabah/4fb1a239-8b70-426b-8390-8f8ca997dc4719.xlsx');
            //DataInsertHeader($("#ContentPlaceHolder1_TrxUploadID").val(), $("#CmbProductCampaign").val())
