...
Public Class WebServiceTransaction
    ...
    Public Function Insert_TransactionTicket(ByVal TrxUsername As String, ByVal TrxCustomerID As String, ByVal TxtThreadID As String, ByVal TxtAccount As String, ByVal TrxPelapor As String, ByVal TrxPelaporEmail As String,
                                             ...
                                             ByVal TrxProductName As String, ByVal TrxReasonCall As String, ByVal TrxTeamLeaderType As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxReasonCall", TrxReasonCall)
                sqlComm.Parameters.AddWithValue("TrxTeamLeaderType", TrxTeamLeaderType)
                con.Open()
                sqlComm.ExecuteNonQuery()
            End Using
        Catch ex As Exception
            ...
            strExec = "exec Insert_Transaction " & "'" & TrxCustomerID & "'," & "'" & strTime & "'," & "'" & TrxChannel & "'," & "'" & TrxCategory & "'," & "'" & TrxLevel1 & "'," & "'" & TrxLevel2 & "'," & "'" & TrxLevel3 & "'," & "'" & HttpUtility.UrlDecode(TrxComplaint) & "'," & "'" & HttpUtility.UrlDecode(TrxResponse) & "'," & "'" & TrxSLA & "'," & "'" & TrxStatus & "'," & "'" & TrxUsername & "'," &
                      ...
                      "" & "'" & TrxKejadian & "'," & "'" & TrxPenyebab & "'," & "'" & TrxStatusPelapor & "'," & "'" & TrxPenerimaPengaduan & "'," & "'" & TrxEskalasi & "'," & "'" & TrxLayer & "'," & "'" & strTrxThreadID & "', " & "'" & strTrxGenesysID & "', " & "'" & strTrxContactID & "'," & "'" & TrxExtendCategory & "'," & "'" & strTrxIDchannel & "'," & "'" & TrxProductName & "', '" & TrxReasonCall & "', '" & TrxTeamLeaderType & "'"
    ...
    Public Function Update_TransactionTicket(ByVal TrxTicketNumber As String, ByVal TrxResponse As String, ByVal TrxStatus As String, ByVal TrxUsername As String,
                                             ...
                                             ByVal DispatchType As String, ByVal TrxDispatchToLayer As String, ByVal TrxPhoneNumber As String, ByVal TrxReasonCall As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Try
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec Update_TransactionTicket_New " & "'" & TrxTicketNumber & "'," & "'" & HttpUtility.UrlDecode(TrxResponse) & "'," & "'" & TrxStatus & "'," & "'" & TrxUsername & "', " & "'" & TrxChannel & "'," & "'" & TrxThreadID & "', " & "'" & TrxGenesysID & "', " & "'" & TrxEscalasiUnit & "', " & "'" & DispatchType & "', '" & TrxDispatchToLayer & "', '" & TrxPhoneNumber & "', '" & TrxReasonCall & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
