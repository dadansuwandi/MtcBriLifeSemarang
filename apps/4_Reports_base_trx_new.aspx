                    ...
                    <div class="box-body p-15">
                      ...
                      <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Nama Peserta" FieldName="CustomerName" Width="150px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Customer Category" FieldName="JenisNasabah" HeaderStyle-HorizontalAlign="left" Width="150px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Channel" FieldName="TicketSourceName" Width="150px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Reason Call" FieldName="ReasonCall" Width="150px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Provider Name" FieldName="ProductName" HeaderStyle-HorizontalAlign="left" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Claim Number" FieldName="NomorRekening" HeaderStyle-HorizontalAlign="left" Width="150px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Escalation Type" FieldName="EscalationTypeName" Width="150px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Tanggal Ticket" FieldName="TanggalTicket" Width="150px"></dx:GridViewDataDateColumn>
                                    <dx:GridViewDataDateColumn Caption="Jam Ticket" FieldName="JamTicket" Width="150px"></dx:GridViewDataDateColumn>
            ...
            <div class="d-flex align-items-center">
                <div class="w-p100 d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><b>Report base On Transaction</b></li>
                            </ol>
                        </nav>
                    </div>
                </div>
