                ...
                <div class="box">
                    ...
                    <div class="box-body p-15">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                            DataSourceID="TempBaseAUX" Width="100%" Styles-Header-Font-Bold="true" Theme="MetropolisBlue" Styles-Cell-HorizontalAlign="Center" Styles-Header-HorizontalAlign="Center">
                            <SettingsPager>
                                <AllButton Text="All">
                                </AllButton>
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="Name" FieldName="AgentName" Width="200px"></dx:GridViewDataTextColumn>
